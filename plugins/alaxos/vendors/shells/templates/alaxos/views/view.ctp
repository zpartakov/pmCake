...
<div class="<?php echo $pluralVar;?> view">
	...
	<?php
	echo "<?php\n";
 	echo "\techo \$this->element('toolbar/toolbar', array('plugin' => 'alaxos', 'add' => true, 'list' => true, 'edit_id' => \${$singularVar}['{$modelClass}']['id'], 'copy_id' => \${$singularVar}['{$modelClass}']['id'], 'delete_id' => \${$singularVar}['{$modelClass}']['id'], 'delete_text' => ___('do you really want to delete this " . strtolower($singularHumanName) . " ?', true)));\n";
 	echo "\t?>\n";
	?>
