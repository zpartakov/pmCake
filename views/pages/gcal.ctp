...
/**
 * display your gcal
 * source: http://james.cridland.net/code/google-calendar.html
 * 
 * */
...
/**
*Modification 08.03.2011 10:56:56 CET frederic.radeff@unige.ch
* a list of stopwords to ignore
*/
$stopwords=";webmaster;webmaster@unige.ch;";
...
if (!isset($calendarfeed)) {$calendarfeed = "https://www.google.com/calendar/feeds/s1okgioa33g6859ru8m57uugvs%40group.calendar.google.com/private-4b468f23f6981e16f7965f13066894f7/basic"; }

// Date format you want your details to appear
$dateformat="j F Y"; // 10 March 2009 - see http://www.php.net/date for details
$dateformat="d-m-Y"; // 10 March 2009 - see http://www.php.net/date for details
...
foreach ($xml->entry as $entry){
	...
	#$description = eregi_replace('([_.0-9a-z-]+@([0-9a-z][0-9a-z-]+\.)+[a-z]{2,3})','<a href="mailto:\\1">\\1</a>', $description);
	/**
	*Modification 08.03.2011 11:02:47 CET frederic.radeff@unige.ch
	removed urlize
	*/
$description=$entry->content;
   ...
   /*  */              
	if (($items_to_show>0 AND $items_shown<$items_to_show)) {
		...
		echo $temp_event;
/*
if(!preg_match("/;".$description.";/",$stopwords)) {
