...
/* presents events on a monthly calendar
 * */
?> 
...
<th width="20%">
	...
	<tr>
		...
		<td style="background-color: transparent;text-align: right"><form action="<?php echo CHEMIN ."/events/calendrier";?>" method="GET"><input type="hidden" name="mois" value="12" /><input type="hidden" name="annee" value="<?php echo $annee_selectionne-1;?>" /><button type="submit" name="bt_month_less" title="-" class="im">&laquo;</button></form></td>
		<?php }else{ ?>
		<td style="background-color: transparent;text-align: right"><form action="<?php echo CHEMIN ."/events/calendrier";?>" method="GET"><input type="hidden" name="mois" value="<?php echo ($mois_selectionne=="1") ? $mois_selectionne : $mois_selectionne-1;?>" /><input type="hidden" name="annee" value="<?php echo $annee_selectionne;?>" /><button type="submit" name="bt_month_less" title="-" class="im">&laquo;</button></form></td>
		<?php } ?>
	<td style="background-color: transparent;">
	<form name="form_mois" action="<?php echo CHEMIN ."/events/calendrier";?>" method="GET"><input type="hidden" name="annee" value="<?php echo $annee_selectionne;?>" />
	...
	<td style="background-color: transparent;text-align: left"><form action="<?php echo CHEMIN ."/events/calendrier";?>" method="GET"><input type="hidden" name="mois" value="1" /><input type="hidden" name="annee" value="<?php echo $annee_selectionne+1;?>" /><button type="submit" name="bt_month_plus" title="+" class="im">&raquo;</button></form></td>
	<?php }else{ ?>
	<td style="background-color: transparent;text-align: left"><form action="<?php echo CHEMIN ."/events/calendrier";?>" method="GET"><input type="hidden" name="mois" value="<?php echo ($mois_selectionne==12) ? $mois_selectionne : $mois_selectionne+1;?>" /><input type="hidden" name="annee" value="<?php echo $annee_selectionne;?>" /><button type="submit" name="bt_month_plus" title="+" class="im">&raquo;</button></form></td>
	<?php } ?>
	</tr>
	</table>
</th>
	...
	<tr>
	<td style="background-color: transparent;text-align: right"><form action="<?php echo CHEMIN ."/events/calendrier";?>" method="GET"><input type="hidden" name="mois" value="<?php echo $mois_selectionne;?>" /><input type="hidden" name="annee" value="<?php echo ($annee_selectionne>1920) ? $annee_selectionne-1 : $annee_selectionne;?>" /><button type="submit" name="bt_year_less" title="-" class="im">&laquo;</button></form></td>
	<td style="background-color: transparent;">
	<form name="form_annee" action="<?php echo CHEMIN ."/events/calendrier";?>" method="GET">
	...
	<td style="background-color: transparent;text-align: left"><form action="<?php echo CHEMIN ."/events/calendrier";?>" method="GET"><input type="hidden" name="mois" value="<?php echo $mois_selectionne;?>" /><input type="hidden" name="annee" value="<?php echo ($annee_selectionne<(date("Y")+1)) ? $annee_selectionne+1 : $annee_selectionne;?>" /><button type="submit" name="bt_year_plus" title="+" class="im">&raquo;</button></form></td>
	</tr>
	</table>
</th>
</tr>
...
calendrier($annee_selectionne,$mois_aff,$jour_aff);
echo "</td>";
}
else{
