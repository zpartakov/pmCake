...
<?php echo $this->Form->create('WebcalEntry');?>
	<fieldset>
		<legend><?php __('Edit Webcal Entry'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('WebcalEntry.cal_id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('WebcalEntry.cal_id'))); ?></li>
