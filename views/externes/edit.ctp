...
<?php echo $form->create('Externe');?>
	<fieldset>
 		<legend><?php __('Edit Externe');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('Externe.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Externe.id'))); ?></li>
