...
<?php echo $this->Form->create('PmMember');?>
	<fieldset>
 		<legend><?php __('Edit Pm Member'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('PmMember.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('PmMember.id'))); ?></li>
